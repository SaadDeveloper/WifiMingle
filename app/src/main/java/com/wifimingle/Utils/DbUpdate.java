...
import com.wifimingle.Network.DownloadFile;
...
public class DbUpdate extends AsyncTask<Void, String, Void> {
    ...
    private final static String DB_REMOTE = "http://wifi_logo.lamatricexiste.info/%s.gz";
        ...
        if (mActivity != null) {
            ...
            if (d != null) {
                ...
                try {
                    ...
                    edit.putInt(com.wifimingle.Utils.Prefs.KEY_RESET_NICDB, d.getPackageManager().getPackageInfo(
